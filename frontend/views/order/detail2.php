...
<!--                    <div class="g-upload"><img src="/Public/frontend/images/pice14.jpg" alt=""></div>-->
<!--                </div>-->
                <div class="item">
            ...
            <div class="g-orderdetailpaybox g-orderdetailpaybox2">
                ...
                <div class="item total">
                    <div class="tit2" style="color: #6B38A5;font-weight: bold;"><span>结算积分</span><?= $order['money']?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="g-botmanagement g-ft-orderdetailpay">
        <div class="bot2">
            ...
            <div class="m-managementbtn">
                ...
                <a href="<?= \yii\helpers\Url::to(['order/pay','id'=>$order['id']])?>" class="btn btn2">立即付款</a>
                <?php }?>
