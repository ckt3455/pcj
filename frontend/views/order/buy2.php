...
<form method="post" action="<?= Url::to(['order/add-order2'])?>" enctype="multipart/form-data">
    ...
    <div class="row-cart row-confirmorder  g-stick">
                        ...
                        <div class="wp">
                            <div class="box-inner box-inner1">
                                            ...
                                            <div class="conr">
                                                ...
                                                <div class="txt">
                                                    ...
                                                    <div class="bot">
                                                        <div class="g-spinner">
                                                            <div class="bot">
                                                                <div class="price">积分<span><?= $goods->price?></span></div>
                                ...
                                <div class="g-orderdetailpaybox g-orderdetailpaybox2 m-confirmorderboxe2">
                                    <div class="top">明细</div>
                                    <div class="item">
                                        <div class="tit1">所需积分</div>
                                        <div class="tit2" style="color: #6B38A5;font-weight: bold;" id="goods_price">积分<?= $goods->price?></div>
                                    </div>
                                    <div class="item">
        ...
        <div class="ft-confirmorder">
            <div class="ftl">
                所需积分<br>
                <span class="price">积分<em id="total_price"><?= $goods->price?></em></span>
            </div>
