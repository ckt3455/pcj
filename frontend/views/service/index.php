...
use yii\helpers\Url;
$seo=SetImage::getOne(['type'=>104]);
$this->title=$seo['title'];
$this->metaTags['keywords']=' <meta name="keywords" content="'.$seo["subtitle"].'">';
$this->metaTags['description']=' <meta name="description" content="'.$seo["describe"].'">';
?>
...
<div class="index_1">
    ...
    <div class="solutions_1 wap_1 display_left" data-aos="fade-up">
        <?php foreach ($model as $k=>$v){?>
            <a href="<?= Url::to(['service/detail','id'=>$v['id']])?>" class="solutions_2 hover_img">
                <div class="solutions_3 display_center">
                    <img src="<?= $v['image']?>" alt="">
                </div>

                <div class="solutions_4 display_left">
                    <div class="solutions_5 flex_1">
                        <h2 class="fb18"><?= $v['title']?></h2>
                    </div>
                    <div class="solutions_6 display_center">
                        <img src="/Public/frontend/images/icon_60.png" alt="">
                    </div>
                </div>
    ...
    <div class="solutions_7 wap_1" data-aos="fade-up">

        <?= \common\components\LinkPager::widget([

            'options'=>['class'=>'product_list_25 display_right'],
