...
<!--            <div class="desc">购买后可成为VIP</div>-->
            <div class="bot">
                ...
                <div class="price" style="display: flex;align-items: center">
                    ...
                    <?php if($number>0){?>
                    <div class="x_tips">买1赠<?= $number?></div>
                    <?php }?>
                </div>
    ...
    <div class="wp">
        <div class="inner">
            ...
            <div class="m-prodetail-btn">
                <a href="<?= \yii\helpers\Url::to(['cart/add-cart', 'id' => $goods['id']]) ?>" class="btn" style="background: #9495AC;">加入购物车</a>
                <a href="<?= \yii\helpers\Url::to(['order/buy','id'=>$goods['id']])?>" class="btn btn2">立即购买</a>
            </div>
        </div>
    </div>
</div>
