...

{
...

    {
        ...
        for ($i = $beginPage; $i <= $endPage; ++$i) {
            ...
            $buttons[] = $this->renderPageButton($i + 1, $i, null, false, $i == $currentPage,2);
        ...
        if ($this->nextPageLabel !== false) {
            ...
            $buttons[] = "<a href=" . $this->pagination->createUrl($page) . " class=\"next\">></a>";
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active,$type=1)

    {
        ...
        if($type==1){
            return Html::a("$label", "$href", $options);
        }else{
            if($active){
                return    '<a href="'.$href.'" class=" '.$this->activePageCssClass.'">'.$label.'</a>';
            }else{
