...
/**
 * BuyerWorkerSearch represents the model behind the search form about `backend\models\BuyerWorker`.
 */
class BuyerWorkerSearch extends BuyerWorker
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'buyer_id', 'user_id', 'created_at', 'updated_at'], 'integer'],
