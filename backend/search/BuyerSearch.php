...
/**
 * BuyerSearch represents the model behind the search form about `backend\models\Buyer`.
 */
class BuyerSearch extends Buyer
{
    ...
    {
        return [
            [['id', 'user_id', 'level_id', 'created_at', 'updated_at'], 'integer'],
            [['goods_money', 'money'], 'number'],
            [['code', 'province', 'city', 'area'], 'safe'],
