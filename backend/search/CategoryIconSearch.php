...
/**
 * CategoryIconSearch represents the model behind the search form about `backend\models\CategoryIcon`.
 */
class CategoryIconSearch extends CategoryIcon
{
    /**
     * @inheritdoc
     */
