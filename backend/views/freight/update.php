                ...
                <div class="form-horizontal form-validate">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sort" class="form-control" value="<?php echo $model->sort ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" id="dispatchname" name="title" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <label class="radio-inline"><input type="radio" name="is_default" id="isdefault1"
                                                               value="1" <?php if ($model->is_default == 1) {
                                    echo "checked";
                                } ?>>
                                是</label>
                            ...
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="show_h text-center">
                                        <input type="text" value="<?php echo $model->first ?>" class="form-control"
                                               name="first"
                                               style="width:80px;">
                                    </td>
                                    <td class="show_h text-center">
                                        <input type="text" value="<?php echo $model->first_money ?>"
                                               class="form-control" name="first_money"
                                               style="width:80px;">
                                    </td>
                                    <td class="show_h text-center">
                                        <input type="text" value="<?php echo $model->next ?>" class="form-control"
                                               name="next"
                                               style="width:80px;">
                                    </td>
                                    <td class="show_h text-center">
                                        <input type="text" value="<?php echo $model->next_money ?>" class="form-control"
                                               name="next_money"
                                               style="width:80px;">
                                    </td>
                                </tr>
                                <?php if (isset($model->detail)) foreach ($model->detail as $k => $v) {
                                    $city = explode(';', $v->city_id);
                                    $city_model = \backend\models\Provinces::find()->where(['in', 'id', $city])->all();
                                    $city_name = [];
                                    foreach ($city_model as $k2 => $v2) {
                                        $city_name[] = $v2->areaname;
                                    }
                                    $city_title = implode(',', $city_name);
                                    ?>
                                    <tr class="redit_<?php echo $v->id; ?>">
                                        <td style="word-break:break-all;width:80px;padding:10px;line-height:22px;overflow:hidden; white-space: normal;">
                                            <span class="edit_<?php echo $v->id; ?>"></span>
                                            <input type="hidden" class="city_ids" value="<?php echo $city_title ?>"/>
                                            <input type="hidden" class="citys" name="citys[]"
                                                   value="<?php echo $v->city_id ?>">
                                            <?php echo $city_title ?>
                                            <a href="javascript:;" onclick="editArea(this)"
                                               random="edit_<?php echo $v->id; ?>">编辑</a>
                                            <input type="hidden" class="citys_code" name="citys_code[]" value="">

                                        </td>
                                        <td class="show_h text-center" valign="top" style="padding-top:10px;"><input
                                                    type="text" value="<?php echo $v->first ?>" class="form-control"
                                                    name="firstweight[]" style="width:80px;"></td>
                                        <td class="show_h text-center" valign="top" style="padding-top:10px;"><input
                                                    type="text" value="<?php echo $v->first_money ?>"
                                                    class="form-control" name="firstprice[]" style="width:80px;"></td>
                                        <td class="show_h text-center" valign="top" style="padding-top:10px;"><input
                                                    type="text" value="<?php echo $v->next ?>" class="form-control"
                                                    name="secondweight[]" style="width:80px;"></td>
                                        <td class="show_h text-center" valign="top" style="padding-top:10px;"><input
                                                    type="text" value="<?php echo $v->next_money ?>"
                                                    class="form-control" name="secondprice[]" style="width:80px;"></td>
                                        <td style="text-align: center;padding-top:10px;" valign="top"><a
                                                    href="javascript:;" class="btn btn-danger btn-sm"
                                    ...
                                    <li>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" class="city" id="<?php echo $v2->areaname ?>"
                                                   ...
                                                   city="<?php echo $v2->id ?>"> <?php echo $v2->areaname ?>
                                        </label>
                                    </li>
                                <?php } ?>
