...
/* @var $model backend\search\BuyerOrderSearch */
...
<div class="row">
    ...
    <?= $form->field($model, 'status',['options'=>['tag'=>false]]) ?>

    <?php // echo  $form->field($model, 'pay_type',['options'=>['tag'=>false]]) ?>

    <?php // echo  $form->field($model, 'order_number',['options'=>['tag'=>false]]) ?>

    <?php // echo  $form->field($model, 'money',['options'=>['tag'=>false]]) ?>

    <?php // echo  $form->field($model, 'discount',['options'=>['tag'=>false]]) ?>

    <?php // echo  $form->field($model, 'total_money',['options'=>['tag'=>false]]) ?>
    ...
    <?php // echo  $form->field($model, 'audit_time',['options'=>['tag'=>false]]) ?>
