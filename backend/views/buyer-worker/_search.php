...
/* @var $model backend\search\BuyerWorkerSearch */
...
<div class="row">
    ...
    <?= $form->field($model, 'sales_money',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'buyer_money',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'get_money',['options'=>['tag'=>false]]) ?>

    <?php // echo  $form->field($model, 'user_id',['options'=>['tag'=>false]]) ?>
