...
/* @var $model backend\search\BuyerSearch */
...
<div class="row">
    ...
    <?= $form->field($model, 'level_id',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'goods_money',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'money',['options'=>['tag'=>false]]) ?>

    <?php // echo  $form->field($model, 'code',['options'=>['tag'=>false]]) ?>
