...
<div class="set-image-form">
    ...
    <?php if (isset($message['status'])) { ?>
        ...
        <?= $form->field($model, 'status')->radioList([1 => '两个图标', 2 => '单图']) ?>
    <?php } ?>
    ...
    <?php if (isset($message['image3_subtitle'])) { ?>
        <?php if ($message['image3_subtitle'] ==1) { ?>
            <?= $form->field($model, 'image3_subtitle')->textInput(['maxlength' => true]) ?>
        <?php } else { ?>
            <?= $form->field($model, 'image3_subtitle')->textInput(['maxlength' => true])->label($message['image3_subtitle']) ?>
        <?php } ?>
    ...
    <?php if (isset($message['image_4_title'])) { ?>


        <?php if ($message['image_4_title'] ==1) { ?>
            <?= $form->field($model, 'image_4_title')->textInput(['maxlength' => true]) ?>
        <?php } else { ?>
            <?= $form->field($model, 'image_4_title')->textInput(['maxlength' => true])->label($message['image_4_title']) ?>
        <?php } ?>
    ...
    <?php if (isset($message['image_4_subtitle'])) { ?>
        <?php if ($message['image_4_subtitle'] ==1) { ?>
            <?= $form->field($model, 'image_4_subtitle')->textInput(['maxlength' => true]) ?>
        <?php } else { ?>
            <?= $form->field($model, 'image_4_subtitle')->textInput(['maxlength' => true])->label($message['image_4_subtitle']) ?>
        <?php } ?>

    <?php } ?>

    <?php if (isset($message['image_4'])) { ?>
    <?php if ($message['image_4'] ==1) { ?>
        <?= $form->field($model, 'image_4')->widget('backend\widgets\webuploader\Image', [
            'boxId' => 'image_4',
            'options' => [
                'multiple' => false,
            ]
    ...
    <?php if(isset($message['created_at'])){?>
        ...
        <?= $form->field($model, 'created_at', ['options' => ['tag' => false]])->widget(
